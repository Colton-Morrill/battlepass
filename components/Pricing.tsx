...
const tiers = [
  ...
  },
  {
    ...
    href: '#',
    priceMonthly: '$10',
    description: 'A plan that allows for more customization and metrics.',
    features: ['Priority support', 'Unlimited Tasks', 'Custom Notifications', 'Advanced reporting and metrics', 'Access to beta features'],
    featured: true,
  },
]
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
        With our simple pricing you can make sure that you are paying for what you need. We encourage to try our free tier and then upgrade if you feel the need.
      </p>
